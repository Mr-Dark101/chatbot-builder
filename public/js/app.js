...
(function (window, document, $) {
  ...
  var assetPath = '/eoceanwab/resources/theme1/assets/';
...
function GetRandomColor(initial)
{
	...
	if(initial == 'A' || initial == 'E'|| initial == 'L'|| initial == 'Q')
	{
		return 'avatar bg-warning';
	}
	else if(initial == 'B'|| initial == 'H'|| initial == 'N'|| initial == 'S')
	{
		return 'avatar bg-danger';
	}
	else if(initial == 'C'|| initial == 'O'|| initial == 'R'|| initial == 'Y')
	{
		return 'avatar bg-success';
	}
	else if(initial == 'D'|| initial == 'I'|| initial == 'P'|| initial == 'W')
	{
		return 'avatar bg-info';
	}
	else if(initial == 'F'|| initial == 'J'|| initial == 'U'|| initial == 'X')
	{
		return 'avatar bg-primary bg-darken-1';
	}
	else if(initial == 'G' || initial == 'T' || initial == 'V')
	{
		return 'avatar bg-secondary bg-darken-1';
	}
	else if(initial == 'M'|| initial == 'Z'|| initial == 'K')
	{
		return 'avatar bg-secondary bg-dark';
	}
	else
	{
...
var initialName = $('span.user-name.font-weight-bolder').text();
var initial = GetInitial(initialName);
