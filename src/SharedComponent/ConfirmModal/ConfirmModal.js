...
const ConfirmModal = ({style, visible, modalTitle, modalText, onHide, okText, modalInfo, isDelete, handleOk, handleCancel }) => {
    return (
        <div >
            <Modal
            onHide={onHide}
            ...
            > 
                <div className="modal-content modalBorderRadius">
                    ...
                    <div className="modal-footer">
                        ...
                        {
                            isDelete?
                            <button type="submit" className="btn-sm btn-danger customfontWeight border create-team-btn rounded-pill" onClick={handleOk}>
