        ...
        <div className="nav-bar-cont left_navbar">
            ...
            <div className="nLink-group">
                <Link to={`${STRINGS.ROUTES.ROOT}?org=${localStorage.getItem("userId")}`} className="nLink">
                    <div className="icon"><img alt={"#"} src={home_icon} margin-top= "20px" height= {"42.4285rem"} width= {"42.4285rem"} font-size= {"1.45rem"} margin-right= {"1.1rem"} /></div>
                    <div/>
                </Link>
            </div>
            ...
            <div className="nLink-group">
                ...
                <a href="https://eoceanwabaqa.com/eoceanwab/holisticanalysis/index">
                   <div className="icon"><img alt={"#"} src={analysis_icon} height=  {"23.4285rem"} width= {"23.4285rem"} font-size= {"1.45rem"} margin-right= {"1.1rem"}/></div>
                    <div/>
                </a>
                </Link>                             
            ...
            <div className="nLink-group">
                ...
                <a href="https://eoceanwabaqa.com/eoceanwab/chatmanager/index">
                    <div className="icon"><img alt={"#"} src={chat_icon}  height=  {"23.4285rem"} width= {"23.4285rem"} font-size= {"1.45rem"} margin-right= {"1.1rem"}/></div>
                    <div/>
                </a>
                </Link>                             
            ...
            <div className="nLink-group">
                ...
                <a href="https://eoceanwabaqa.com/eoceanwab/campaignmessages/index?msgType=">
                    <div className="icon"><img alt={"#"} src={template_icon} height=  {"23.4285rem"} width= {"23.4285rem"} font-size= {"1.45rem"} margin-right= {"1.1rem"}/></div>
                    <div/> </a>
                </Link>                             
            ...
            <div className="nLink-group">
                ...
                <div className="icon"><img alt={"#"} src={teams_icon} height=  {"23.4285rem"} width= {"23.4285rem"} font-size= {"1.45rem"} margin-right= {"1.1rem"}/></div>
                    <div/></a>
                </Link>                             
            ...
            <div className="nLink-group">
                ...
                <a href="https://eoceanwabaqa.com/eoceanwab/WhatsappManager/profilesettings">
                    <div className="icon"><img alt={"#"} src={users_icon} height=  {"23.4285rem"} width= {"23.4285rem"} font-size= {"1.45rem"} margin-right= {"1.1rem"}/></div>
                    <div/>
                    </a>
                </Link>                             
            ...
            <div className="nLink-group">
                ...
                <a href="https://eoceanwabaqa.com/eoceanwab/contacts/index?name=&number=&email=&status=&customAttributes=&pageSize=">
                    <div className="icon"><img alt={"#"} src={tags_icon} height=  {"36.4285rem"} width= {"36.4285rem"} font-size= {"1.45rem"} margin-right= {"1.1rem"} style= {{ "border-bottom":'1px solid #D0D0D0',"padding-bottom": "15px"}}/></div>
                    <div/>
                    </a>
                </Link>                             
            ...
            <div className="nLink-group">
                ...
                <Link to={`https://eoceanwab.com/org=1`} target="_blank" rel="noopener noreferrer" className="nLink">
                    ...
                    <div className="icon"><img alt={"#"} src={chatbot_builder} height=  {"23.4285rem"} width= {"23.4285rem"} font-size= {"1.45rem"} margin-right= {"1.1rem"}/></div>
                    <div/>
                    </a>
                </Link>                             
            ...
            <div className="nLink-group">
                ...
                <a href ="https://eoceanwabaqa.com/eoceanwab/channels/index">
                    <div className="icon"><img alt={"#"} src={share_icon} height=  {"23.4285rem"} width= {"23.4285rem"} font-size= {"1.45rem"} margin-right= {"1.1rem"}/></div>
                    <div/>
                    </a>
                </Link>                             
            ...
            <div className="nLink-group">
                ...
                <a href ="https://eoceanwabaqa.com/eoceanwab/integrations/index">
                    <div className="icon"><img alt={"#"} src={tags_icon} height=  {"23.4285rem"} width= {"23.4285rem"} font-size= {"1.45rem"} margin-right= {"1.1rem"}/></div>
                    <div/>
                    </a>
                </Link>                             
            ...
            <div className="nLink-group">
                ...
                <a href ="https://eoceanwabaqa.com/eoceanwab/usermanagement/summary">
                    <div className="icon"><img alt={"#"} src={user_icon} height=  {"23.4285rem"} width= {"23.4285rem"} font-size= {"1.45rem"} margin-right= {"1.1rem"}/></div>
                    <div/>
                </a>
                </Link>                             
            ...
            <div className="nLink-group">
                ...
                <a href ="https://eoceanwabaqa.com/eoceanwab/teammanagement/summary?teamName=&status=">
                    <div className="icon"><img alt={"#"} src={team_icon} height=  {"36.4285rem"} width= {"36.4285rem"} font-size= {"1.45rem"} margin-right= {"1.1rem"} style= {{ "border-bottom":'1px solid #D0D0D0',"padding-bottom": "15px"}}/></div>
                    <div/>
                    </a>
                </Link>                             
            ...
            <a href ="https://eoceanwabaqa.com/eoceanwab/whatsnew/index">
                    <div className="icon"><img alt={"#"} src={star_icon} height=  {"23.4285rem"} width= {"23.4285rem"} font-size= {"1.45rem"} margin-right= {"1.1rem"}/></div>
                    <div/>
                    </a>
                </Link>
            ...
            <a href ="https://eoceanwabaqa.com/eoceanwab/billing/index">
                    <div className="icon"><img alt={"#"} src={billing_icon} height=  {"23.4285rem"} width= {"23.4285rem"} font-size= {"1.45rem"} margin-right= {"1.1rem"}/></div>
                    <div/>
                    </a>
                </Link>
            ...
            <a href ="https://eoceanwabaqa.com/eoceanwab/accountsettings/index">
                    <div className="icon"><img alt={"#"} src={setting_icon} height=  {"23.4285rem"} width= {"23.4285rem"} font-size= {"1.45rem"} margin-right= {"1.1rem"}/></div>
                    <div/>
                    </a>
                </Link>
