...
import { onSuccessUpdateMenuText, resetTheUrls, UpdateTrigger, UpdateTriggerMenusText, uploadFile } from './slices/addTrigger.slice';
let updatedTriggers = [];
let counter = 0;
         ...
         <div className="add_api_section" style={{ border: '1px solid #000', borderColor: '#000', width: '100%', borderWidth: 1, padding: 10, marginTop: 10 }}>
            ...
            <div className="row__" style={{ marginTop: '20px' }}>
               ...
               <div className="add-btn api_button_section">
                  ...
                  <button className="btn btn-danger btnPadding" onClick={saveCondition}>
                     Save Condition
                  </button>
               </div>
