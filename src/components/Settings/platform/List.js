...
useEffect(() => {
  ...
  const retrieveList = () => {
    CrudService.getAll('platform',true)
      .then(response => {
...
/>
      ...
      <div className="page_data_setting">
      {
                  ...
                  <div className="col-sm-3">
                    <h3 className="page_heading m-0">Platform</h3>
                  </div>

                  <div className="col-sm-9">
                    <button type="button" onClick={() => subPage(<Create loadList={loadList} retrieveList={retrieveList} rs={rs} />)} className="btn primary pull-right">Add New Platform</button>
                  </div>
                </div>
...
<div className="table-responsive mx-30">
 ...
 <tbody>
            ...
            listData.map((row, index) => (
                  ...
                  <BlankMsg message="There are no platform details added" icon="mdi mdi-phone-plus" buttonName="Add Platform" button={ () => subPage(<Create loadList={loadList} retrieveList={retrieveList} rs={rs} />)} />
