                        ...
                        <Form enableReinitialize validationSchema={FormSchema} initialValues={formData} onSubmit={onSubmit}>
                           ...
                           <div className="row" style={{ marginLeft: '0px', marginRight: '0px' }}>
                              <div className="col-9" style={{ paddingLeft: '0px', paddingRight: '0px' }}>
                                 ...
                                 <div className="field_section">
                                    <SelectField name="api_type" label="Type" options={typeList} />
                                 </div>
                                 ...
                                 <div className="field_section mb-20">
                                    <SelectField name="platform_id" label="Platform" options={platformList} />
                                 </div>

                                 <div className="field_section mb-20">
                                    <TextAreaField name="payload" label="Payload" placeholder="Payload" rows="3" />
                                 </div>
                              </div>
