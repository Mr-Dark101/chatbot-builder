                        ...
                        <div className="navbar-brand logo_section">
                           ...
                           <ul>
                              <li className={activeClass === 'dashboard' ? `active` : null}>
                                 ...
                                 <Link onClick={() => setActiveClass('dashboard')} to={`${props.prefix}/dashboard`}>
                                    <img className="img-responsive" src="/app/images/header_icon_img.png" />
                                 </Link>
                              </li>
                                 ...
                                 <div className="col-sm-12">
                                    <ul className="navbar-nav">
                                       {user.userdata.is_superadmin == 1 ? (
                                          <>
                                             <li>
                                                <Link to={`${props.prefix}/customer`}>Customer</Link>
                                             </li>
                                          </>
                                       ) : (
                                          <>
                                             <li>
                                                <Link to={`${props.prefix}/bot`}>BOT Builder</Link>
                                             </li>
                                          </>
                                       )}
                                    </ul>
                     ...
                     <div className="col-sm-3">
                        <div className="float-end header_user_end_section">
                           <div className="header_icon_section">
                              <ul>
                                 <li>
                                    <Link className={activeClass === 'setting' ? `active` : null} onClick={() => setActiveClass('setting')} to={`${props.prefix}/setting`}>
                           ...
                           <div className="user_section">
                              ...
                              <div className="user_img_section dropdown">
                                 ...
                                 <ul className="dropdown-menu login_dropdown text-center">
                                    ...
                                    <li>
                                       <button className="login_dropdown_btn" href="#" onClick={logOut}>
                                          {' '}
                                          Sign Out
                                       </button>
                                    </li>
                                    ...
                                    <li>
                                       <button className="login_dropdown_btn" href="#">
                                          {' '}
                                          Change Password
                                       </button>
                                    </li>
