...
const Templates = () => {
   ...
   return (
      <div className="ws-hld dashboard-hld ov-des overflow-auto">
         ...
         <AlertModal visible={isAlert} handleOk={alertClose} confirmLoading={!isUpdatedList} modalText={confirmationTxt} modalInfo={[]} handleCancel={alertClose} />
         <div className="head">
                           ...
                           <UserBotsCardItem
                              ...
                              onAddBot={(obj) => {
                                 setInit({
                                    ...
                                    isAlert: false,
                                    isUpdatedList: true,
                                    confirmationTxt: `You are about to add ${d.name} bot into your workspace. Are you sure?`,
                                    currentObject: obj,
                                 });
                              }}
                              dashboard={dashboard}
